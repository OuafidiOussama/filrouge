...
<section class="overflow-none w-screen h-screen flex justify-center items-center">
    ...
    <div class="relative z-10 bg-white w-3/4 h-5/6 rounded-xl flex">
        <div class="relative w-1/2 h-full top-0 left-0 rounded-xl ">
            ...
            <span class="absolute top-[35%] left-[5%] text-white text-9xl font-extrabold">LOGIN</span>
        </div>
        ...
        <div class="w-1/2 h-full flex flex-col justify-center items-center z-10 relative">
            <form action="check" method="POST" class="w-full h-full flex flex-col justify-center items-center">
                @csrf
                ...
                <p class="pt-5">Don't have an account? <a href="/register" class="hover:underline hover:text-red-400">Register</a></p>
            </form>
        </div>
    </div>
</section>
